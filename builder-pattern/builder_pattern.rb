#Code based on the one made by Kempiński, Krzysztof
#Available on https://medium.com/kkempin/builder-design-pattern-in-ruby-dfa2d557ff1b
#Retrieved on Jan 28 2020
...
first_user = UserBuilder.build do |builder|
